...
{
    /// <summary>
    /// Serializes and deserializes TradeMe request and access tokens so that they can be used by other application components.
    /// </summary>
    public class RequestTokenSerializer : IDataSerializer<RequestToken>
    {
        ...
        /// <returns>The TradeMe request token</returns>
        ...
        /// <summary>
        /// Writes a TradeMe request token as a series of bytes. Used by the <see cref="Serialize"/> method.
        /// </summary>
        ...
        /// <summary>
        /// Reads a TradeMe request token from a series of bytes. Used by the <see cref="Deserialize"/> method.
        /// </summary>
